...
export class RuleController {
  ...
  async getComment(
    ...
    try {
      const result = await this.ruleService.getComment(
  ...
  async getMemberList(
    ...
    try {
      const memberList = await this.ruleService.getMemberList(
        req.user.id,
        ruleId,
      );
      return new ResponseDto(
  ...
  async getSearchMemberAtCreate(
    ...
    try {
      const result: CursorPageDto<GetSearchMemberAtCreateDto> =
        await this.ruleService.getSearchMemberAtCreate(
          cursorPageOptionsDto,
          req.user.id,
          searchTerm,
        );
  ...
  async getSearchMemberAtUpdate(
    ...
    try {
      const result: CursorPageDto<GetSearchMemberDto> =
        await this.ruleService.getSearchMemberAtUpdate(
          cursorPageOptionsDto,
          req.user.id,
          ruleId,
          searchTerm,
  ...
  async getDetail(
    ...
    await this.ruleService.getDetail(req.user.id, ruleId);
  ...
  async updateRule(
    ...
    try {
      const result = await this.ruleService.updateRule(
        updateRuleDto,
        req.user.id,
        ruleId,
      );
